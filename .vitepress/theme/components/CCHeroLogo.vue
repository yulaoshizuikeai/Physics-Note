      ...
      <div class="tilt-layer" :style="tiltStyle">
        ...
        <div class="face front">
          <svg viewBox="0 0 330 380" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect y="29.6086" width="285.591" height="352" rx="18" transform="rotate(-5.74915 0 29.6086)" fill="var(--atom-cover)"/>
            
            <!-- Front page -->
            <g filter="url(#f-shadow)">
              <rect x="45.5326" y="10" width="274" height="352" rx="18" fill="var(--atom-card-bg)"/>
              <rect x="45.5326" y="10" width="274" height="352" rx="18" fill="url(#f-lines)"/>
              
              <!-- Bohr Atom Orbits -->
              <!-- Orbit 1: 0 deg (Horizontal) -->
              <ellipse cx="182.5" cy="165" rx="66" ry="26" stroke="var(--atom-orbit)" stroke-width="8.5" fill="none" class="atom-orbit orbit-h"/>
              
              <!-- Orbit 2: 60 deg -->
              <ellipse cx="182.5" cy="165" rx="66" ry="26" stroke="var(--atom-orbit)" stroke-width="8.5" fill="none" transform="rotate(60 182.5 165)" class="atom-orbit orbit-d1"/>
              
              <!-- Orbit 3: 120 deg -->
              <ellipse cx="182.5" cy="165" rx="66" ry="26" stroke="var(--atom-orbit)" stroke-width="8.5" fill="none" transform="rotate(120 182.5 165)" class="atom-orbit orbit-d2"/>
              
              <!-- Pulsing Center Nucleus -->
              <g class="nucleus-group">
                <!-- Soft halo pulse -->
                <circle cx="182.5" cy="165" r="22" fill="var(--atom-nucleus)" opacity="0.18" class="nucleus-halo"/>
                <circle cx="182.5" cy="165" r="15" fill="var(--atom-nucleus)" class="nucleus-core"/>
                <!-- Nucleus glint -->
              ...
              <g class="electron-node electron-1">
                <circle cx="248.5" cy="165" r="7.5" fill="var(--atom-electron)"/>
                <circle cx="248.5" cy="165" r="2.5" fill="#ffffff"/>
              </g>

              <!-- Electron 2 (60 deg Orbit) -->
              <g class="electron-node electron-2">
                <circle cx="149.5" cy="107.8" r="7.5" fill="var(--atom-electron)"/>
                <circle cx="149.5" cy="107.8" r="2.5" fill="#ffffff"/>
              </g>

              <!-- Electron 3 (120 deg Orbit) -->
              <g class="electron-node electron-3">
                <circle cx="149.5" cy="222.2" r="7.5" fill="var(--atom-electron)"/>
                <circle cx="149.5" cy="222.2" r="2.5" fill="#ffffff"/>
              </g>
              
              <!-- Underline -->
              <path d="M97.5326 271H267.033" stroke="var(--atom-text)" stroke-width="11" stroke-linecap="round"/>
            </g>
            ...
            <defs>
              ...
              <pattern id="f-lines" patternUnits="userSpaceOnUse" patternTransform="matrix(1370 0 0 40 45.5326 182)" preserveAspectRatio="none" viewBox="0 0 1370 40" width="1" height="1">
                <rect width="274" height="4" fill="var(--atom-lines)"/>
              </pattern>
            </defs>
          </svg>
        </div>
